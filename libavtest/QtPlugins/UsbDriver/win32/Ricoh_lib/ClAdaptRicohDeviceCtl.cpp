...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getZoom( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetZoom( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
									   reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
									   reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
									   reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
									   reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
}
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getExposure( stUVC_STD_PARAM*	pstRetStdVal, stUVC_AUTO_PARAM*	pstRetAutoVal )
{
	return m_clRicohDeviceCtl.GetExposure( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
										   reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
										   reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
										   reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
										   reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ),
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getAutoExposurePriority( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetAutoExposurePriority( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
													   reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
													   reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
													   reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
													   reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getFocus( stUVC_STD_PARAM*	pstRetStdVal, stUVC_AUTO_PARAM* pstRetAutoVal )
{
	return m_clRicohDeviceCtl.GetFocus( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
										reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
										reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
										reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
										reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ),
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getBrightness( stUVC_STD_PARAM*	pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetBrightness( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getContrast( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetContrast( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
										   reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
										   reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
										   reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
										   reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getHue( stUVC_STD_PARAM*	pstRetStdVal, stUVC_AUTO_PARAM*	pstRetAutoVal )
{
	return m_clRicohDeviceCtl.GetHue( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
														  reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
														  reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
														  reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
														  reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ),
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getSaturation( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetSaturation( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getSharpness( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetSharpness( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
											reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
											reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
											reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
											reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getGamma( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetGamma( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
										reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
										reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
										reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
										reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getWhiteBalanceTemperature( stUVC_STD_PARAM*	pstRetStdVal , stUVC_AUTO_PARAM*	pstRetAutoVal )
{
	return m_clRicohDeviceCtl.GetWhiteBalanceTemperature( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
														  reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
														  reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
														  reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
														  reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ),
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getBacklightCompensation( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetBacklightCompensation( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
														reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
														reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
														reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
														reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getGain( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetGain( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
									   reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
									   reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
									   reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
									   reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getPowerLineFrequency( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetPowerLineFrequency( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
													 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
													 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
													 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
													 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getWhiteBalanceFullComponent( stUVC_STD_PARAM*	pstRed,
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getExposureEx( stUVC_STD_PARAM*	pstRetStdVal, stUVC_AUTO_PARAM*	pstRetAutoVal )
{
	return m_clRicohDeviceCtl.GetExposureEx( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getGainEx( stUVC_STD_PARAM*	pstRetStdVal, stUVC_AUTO_PARAM*	pstRetAutoVal )
{
	return m_clRicohDeviceCtl.GetGainEx( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
										 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
										 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
										 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
										 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getPowerLineFrequencyEx( stUVC_STD_PARAM*	pstRetStdVal, stUVC_AUTO_PARAM*	pstRetAutoVal )
{
	return m_clRicohDeviceCtl.GetPowerLineFrequencyEx( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
													  reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
													  reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
													  reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
													  reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getExtension1	( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetExtension1( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getExtension2	( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetExtension2( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getExtension3	( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetExtension3( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getExtension4	( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetExtension4( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getExtension5	( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetExtension5( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getExtension6	( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetExtension6( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getExtension7	( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetExtension7( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
...
// ---------------------------------------------------------------------------------------- //
  /*! ====================================================================================
	...
	=====================================================================================　*/
// ---------------------------------------------------------------------------------------- //
bool	ClAdaptRicohDeviceCtl::getExtension8	( stUVC_STD_PARAM* pstRetStdVal )
{
	return m_clRicohDeviceCtl.GetExtension8( reinterpret_cast< LONG* >( &pstRetStdVal->qlCur ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMin ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlMax ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlRes ),
											 reinterpret_cast< LONG* >( &pstRetStdVal->qlDef ));
