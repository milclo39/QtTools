...
#else
			*(qJpgData.data() + i + JPEG_OFFSET_Y) = uniHeight.ucH;
			*(qJpgData.data() + i + JPEG_OFFSET_Y + 1) = uniHeight.ucL;
			*(qJpgData.data() + i + JPEG_OFFSET_X) = uniWidth.ucH;
			*(qJpgData.data() + i + JPEG_OFFSET_X + 1) = uniWidth.ucL;
#endif
			return true;
		}
	}
...
*/
//--------------------------------------------------------------------------------
void ClDeviceInfo::setConnected(bool bIsConnect)
{
	if(bIsConnect == true)
	{
		m_bIsConnect = true;
