...
/**
 * @brief send license buffer
 * @param[in] version_string       - Pointer to char version buffer
 * @param[in] buf                  - Pointer to buffer of license
 * @param[in] buf_size             - Size of buffer
 * @return     size of written data
 */
uint32_t get_license_buffer(const char* version_string, mc_license_command_id id, void *pData);
