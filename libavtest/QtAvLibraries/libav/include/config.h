...
#define LIBAV_CONFIGURATION "--toolchain=msvc --arch=x86 --enable-yasm --enable-asm --enable-shared --disable-static --prefix=/c/Users/suda/Source/Repos/libs --enable-gpl --enable-nonfree --enable-libx264 --enable-memalign-hack --enable-runtime-cpudetect --enable-dxva2 --disable-hwaccels --enable-hwaccel=h264_dxva2 --extra-cflags='-I/usr/local/include ' --extra-ldflags='-L/usr/local/lib '"
#define LIBAV_LICENSE "nonfree and unredistributable"
#define AVCONV_DATADIR "/c/Users/suda/Source/Repos/libs/share/avconv"
