...
Rectangle {
    id: scene_input_selectmedia_sdimage
    width: 800
    height: 480
    color: "#00000000" //透明
                ...
                if (msg_08.visible == false && msg_09.visible == false) {
                    if (image_del.source == "image://image_provider/:/qmls/images/PXOSD_R0_Memory_del_P.png") {
                        if (deleteMode == false) {
                            ...
                            deleteMode = false
                            stackView.pop(componentInputSelectMediaSDImage)
                            stackView.push(componentInputSelectMediaSDImage)
                        }
                    }
                }
            }
                        ...
                        onClicked: {
                            if (msg_08.visible == false && msg_09.visible == false && index + (pageCurrent - 1) * (row * column) < ScreenMsgProc.list_filepath.length) {
                                ...
                                if (deleteMode == false) {
                                    ...
                                    stackView.push(componentInputSelectMediaSDImagePlayer)
