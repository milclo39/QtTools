...
Rectangle {
    id: scene_setting_system_opsoundvol
    width: 800
    height: 480
    ...
    {
        if (slider.value > 9) {
            ScreenMsgProc.state_set2_S1_07 = slider.value.toString()
            image_current_text1.source = "images/PXOSD_R0_TEXT2_0.png"
        } else {
            ScreenMsgProc.state_set2_S1_07 = "0" + slider.value.toString()
            image_current_text1.source = "images/PXOSD_R0_TEXT2_" + slider.value + ".png"
        }
        if (paramCurrent != ScreenMsgProc.state_set2_S1_07) {
            paramCurrent = ScreenMsgProc.state_set2_S1_07
        }
    ...
    Image {
        ...
        width: 800
        height: 60
        source: "qrc:///Set3_S2_OpSoundVol_title.png"
    }
    ...
    Image {
        x: 300
        y: 176
        source: "qrc:///Set3_S2_OpSoundVol_bg1.png"
    }
    Image {
        x: 0
        y: 328
    ...
    Slider {
        ...
        minimumValue: 0.0
        stepSize: 1.0
        value: ScreenMsgProc.state_set2_S1_07
        x: 70
        y: 327
        style: SliderStyle {
            groove: Image {
