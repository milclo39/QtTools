...
Rectangle {
    id: scene_setting_camera_contrast
    width: 800
    height: 480
    color: "#00000000" //透明
    ...
    {
        if (slider.value > 9) {
            ScreenMsgProc.state_set2_C1_7 = slider.value.toString()
            image_current_text1.source = "images/PXOSD_R0_TEXT2_0.png"
        } else {
            ScreenMsgProc.state_set2_C1_7 = "0" + slider.value.toString()
            image_current_text1.source = "images/PXOSD_R0_TEXT2_" + slider.value + ".png"
        }
        visibleCurentText()
        if (paramCurrent != ScreenMsgProc.state_set2_C1_7) {
            paramCurrent = ScreenMsgProc.state_set2_C1_7
        }
    ...
    Image {
        ...
        width: 800
        height: 60
        source: "qrc:///Set3_C2_Contrast_title.png"
    }
        ...
        MouseArea {
            ...
            onReleased: {
                if (image_default.source == "image://image_provider/:/qmls/images/PXOSD_R0_Default_ON.png") {
                    image_default.source = "image://image_provider/:/qmls/images/PXOSD_R0_Default_OFF.png"
                    ScreenMsgProc.state_set2_C1_7 = "05"
    ...
    Slider {
        ...
        minimumValue: 0.0
        stepSize: 1.0
        value: ScreenMsgProc.state_set2_C1_7
        x: 165
        y: 420
        style: SliderStyle {
            groove: Image {
